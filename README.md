...
Repo for uploading slides and other materials of RISC-V Summit China 2024
...
| 10:10 | 20' | 构筑技术能力，拓展 RISC-V 应用新边界 | 戚肖宁 (阿里巴巴集团副总裁) | TBA | TBA |
| 10:30 | 20' | 推动 RISC-V 产业升级，携手共筑 RDI 新生态 | 何宁 (奕斯伟计算，高级副总裁、首席技术官) | TBA | TBA |
| 10:50 | 20' | 青稞 RISC-V 与接口 PHY 的多快少省 | 杨勇 (沁恒微电子，技术总监、董事) | TBA | TBA |
...
| 14:40 | 15' | 定制芯片时代下的 RISC-V | 刚至坚 (SiFive 全球商务资深副总裁) | TBA | TBA |
| 14:55 | 15' | 新思科技 RISC-V 整体解决方案加速芯片创新 | 黄宗杰 (新思科技应用工程执行总监) | TBA | TBA |
| 15:10 | 15' | RISC-V for Intelligent Edge Application Processing | 苏泓萌 博士 (晶心科技总经理暨首席技术官) | TBA | TBA |
| 15:25 | 15' | RISC-V 在快速增长的数据中心市场展现价值 | 张岩 (SiFive 首席现场应用工程师) | TBA | TBA |
...
| 17:40 | 20' | 坚持标准，共建信赖：为快速增长的 RISC-V 生态引入认证体系 | 史青昊 (James Shi) (阿里巴巴达摩院，高级测试专家) | TBA | TBA |
| 18:00 | 20' | 群芯闪耀：推动 RISC-V 的全面商业化覆盖 | 柯一冉 (深圳市群芯闪耀科技有限公司 (Milk-V)，副总裁) | TBA | TBA |
...
| 09:40 | 20' | 持续迭代创新，打造稳定、高效、易用的玄铁处理器 | 陈晨 (阿里巴巴达摩院，资深技术专家) | TBA | TBA |
| 10:00 | 20' | 一种片上网络的开源实现 | 王齐 (北京开源芯片研究院，总工程师) | TBA | TBA |
| 10:20 | 20' | Optimizing interconnect architectures for high-performance and complex RISC-V based SoCs | Hao Luan (Chief Architect, Arteris) | TBA | TBA |
| 10:40 | 20' | 基于边缘侧 AI MCU 芯片及其应用 | 汪建强 (苏州国芯科技股份有限公司，芯片中心副主任) | TBA | TBA |
| 11:00 | 10' | 面向实时控制应用的 RISC-V 架构 DSP 处理器 | 向远洋 (中科本原科技（北京）有限公司，工程师) | TBA | TBA |
...
| 13:55 | 15' | 基于 RISC-V 云端推理 NPU 的大模型应用实践 | 王得科 (广州希姆半导体 研发副总裁) | TBA | TBA |
| 14:10 | 15' | 高性能计算的挑战与机会 | 钟雷 (爱普存储技术（杭州）有限公司总经理) | TBA | TBA |
| 14:25 | 20' | 面向 RISC-V CPU 的大模型推理引擎 PerfXLM 移植与优化 | 张先轶 (澎峰科技 PerfXLab, CEO) | TBA | TBA |
...
| 17:05 | 10' | RISC-V CPU IP 赋能 AI 时代创芯应用 | 马越 (芯来科技，高级总监) | TBA | TBA |
| 17:15 | 10' | AutoIREE: Automatic Performance Tuning for AI models on RISC-V Vector Architectures | 洪培翔 (Andes Technology, Toolchain Technology Manager) | TBA | TBA |
| 17:25 | 10' | 基于 MLIR 的 RISC-V 编译优化实践：以 Buddy Compiler 为例 | 周旭林 (中国科学院软件研究所硕士研究生)<br/>张洪滨 (中国科学院软件研究所博士研究生) | TBA | TBA |
| 17:35 | 20' | 构建 AIoT 时代 RISC-V 处理器的高效嵌入式集成开发环境 | 方华启 (芯来科技，软件总监) | TBA | TBA |
| 17:55 | 10' | RISC-V & OpenHarmony 助力 AI 云-边-端协同创新 | 于大伍 (江苏润开鸿数字科技有限公司，副总裁) | TBA | TBA |
| 18:05 | 10' | 数据流架构和 RISC-V 相结合：一种 AI 和高性能计算芯片的技术解决方案 | 梅潮 (兆松科技（武汉）有限公司，软件工程师) | TBA | TBA |
| 18:15 | 10' | RISC-V IO 虚拟化架构在 X100 芯片上的实现 | Lv 'ZETALOG' Zheng（郑律） (SpacemiT, CPU 架构总监) | TBA | TBA |
| 18:25 | 20' | 利用人工智能大模型优化 RISC-V 编译器的性能 | 赵正朋 (兆松科技（武汉）有限公司，软件开发工程师) | TBA | TBA |
...
| 13:45 | 15' | 基于 RISC-V 的 DSP 中增强型 PWM 的设计与应用 | 冯新华 (北京中科昊芯科技有限公司，研发工程师) | TBA | TBA |
| 14:00 | 20' | 使用 RISC-V CPU ASIL B/D 开发集成中的挑战与方法 | 范添彬 (芯来科技，车规产品经理) | TBA | TBA |
| 14:20 | 20' | RISC-V 芯片在汽车领域应用机遇与挑战 | 曹常锋 (长城汽车股份有限公司，总工程师) | TBA | TBA |
| 14:40 | 20' | RISC-V 新 32 位嵌入式虚拟化架构 (rv64ilp32 v.s. Armv8-R AArch32 v.s. Infineon TriCore) | 郭任 (达摩院玄铁团队，高级技术专家) | TBA | TBA |
| 15:00 | 20' | Speed the path to certification of your RlSC-V-based product | Niklas Källman (IAR Systems, Senior Product Manager for RISC-V Solutions) | TBA | TBA |
| 15:20 | 10' | RISC-V Architectures for High-integrity Feature Rich Automotive Applications | Matthew Bubis (Director of Product Management, Imagination Technologies) | TBA | TBA |
...
| 17:10 | 10' | RISC-V 云电脑终端软硬件生态分析及应用进展 | 韦茜 (中国电信研究院) | TBA | TBA |
| 17:20 | 10' | 中国移动基于 RISC-V 技术在云终端领域的探索 | 殷萍 (中移（苏州）软件技术有限公司，高级软件技术工程师) | TBA | TBA |
| 17:30 | 10' | RISC-V 在高清云桌面终端领域的应用 | 万峰 (深圳市青葡萄科技有限公司创始人) | TBA | TBA |
| 17:40 | 10' | RISC-V OpenStack 与 k8s 开发实践分享 | 周良 (奕斯伟计算，资深软件工程师)<br/>郑宇 (奕斯伟计算，智能计算事业部软件研发高级总监) | TBA | TBA |
| 17:50 | 20' | RISC-V SoC JH7110 工业实时系统方案落地探索 | 陈敏达 (赛昉科技，高级主管工程师) | TBA | TBA |
| 18:10 | 20' | 面向数据中心的 RISC-V 视频转码卡应用实践 | 李天正 (中国电信研究院，RISC-V 指令集研究员) | TBA | TBA |
...
| 10:00 | 20' | GCC RVV 自动向量化及其应用 | 李盼 (Intel, RISC-V Compiler Engineer) | TBA | TBA |
| 10:20 | 20' | 奕斯伟 RISC-V GCC 工具链开发实践分享 | 高斐 (奕斯伟计算，编译器技术专家)<br/>王峰 (奕斯伟计算，编译器技术专家) | TBA | TBA |
| 10:40 | 20' | QEMU for RISC-V 的整体进展 | 刘志伟 (阿里巴巴达摩院 RISC-V 及生态，技术专家) | TBA | TBA |
| 11:00 | 20' | Leveraging the RISC-V Efficient Trace (E-Trace) Standard | Yifan Li (SIEMENS EDA, Tessent Account Technology Manager) | TBA | TBA |
...
| 13:50 | 20' | openEuler RISC-V 2024: 我们如何驯服碎片化 | 王经纬 (中国科学院软件研究所，工程师) | TBA | TBA |
| 14:10 | 20' | openKylin 在 RISC-V 上的最新进展和创新技术 | 王文竹 (openKylin 社区技术委员会 委员) | TBA | TBA |
...
| 16:50 | 10' | TBA |  | TBA | TBA |
| 17:00 | 20' | Practical Approaches to Developing and Integrating ACPI and SMBIOS for RISC-V | Sia Jee Heng (StarFive Technology, Senior Staff Engineer) | TBA | TBA |
| 17:20 | 10' | RISC-V KVM 的调试与调优 | 杜超 (奕斯伟计算，资深软件工程师) | TBA | TBA |
| 17:30 | 10' | Leverage BRS standard to improve RISC-V SW compatibility | 许海波 (Intel, RISC-V Software Engineer)<br/>Andrei Warkentin (Intel, Principal Engineer) | TBA | TBA |
| 17:40 | 20' | Soft-ISA: kernel built-in emulation engine to extend RISC-V silicon ISA capability | Haicheng Li (Intel, System Software Architect)<br/>Xiao Wang (Intel, System Software Engineer) | TBA | TBA |
| 18:00 | 10' | 从 StratoVirt 到 KataContainers：基于 H 扩展的软件生态建设 | 何若轻 (中国科学院软件研究所，工程师) | TBA | TBA |
...
| 10:00 | 20' | A Study on Transient Execution Vulnerabilities of RISC-V Implementations（RISC-V 实现的瞬态执行漏洞研究） | Tuo Chen （陈 拓） (IISEC (Institute of Information Security, Japan), Master Student) | TBA | TBA |
| 10:20 | 10' | RISC-V 架构下 OP-TEE 安全系统实践 | 桂兵 (芯来科技，高级软件工程师) | TBA | TBA |
| 10:30 | 10' | 基于 RISC-V 的 HSM 方案 | 王松 (芯来科技，嵌入式研发经理) | TBA | TBA |
| 10:40 | 10' | Enhancing RISC-V Security with SBI Secure Service APIs | 李勇 (英特尔亚太研发有限公司，软件架构师) | TBA | TBA |
| 10:50 | 20' | 基于 RISC-V 处理器架构搭建真实的计算机系统 | 常瑞 (浙江大学，副教授、博士生导师) | TBA | TBA |
...
| 13:50 | 20' | RISC-V 开源硬件产品在云边端上的应用实践 | 吴才泽 (深圳矽速科技有限公司，CTO) | TBA | TBA |
| 14:10 | 10' | 玄铁多核 RTOS 系统平台介绍 | 林书塔 (阿里巴巴达摩院 RISC-V 及生态，技术专家) | TBA | TBA |
| 14:20 | 10' | 利用 WebAssembly 技术解决多种 ISA 的挑战 | Chen Yolanda (Intel, 编译器架构师) | TBA | TBA |
| 14:30 | 20' | QEMU 调用本机动态库加速转译 | 章子杨 (上海交通大学软件学院 TCLOUD 实验室，研究生一年级) | TBA | TBA |
| 14:50 | 20' | 基于开源 IP、SoC 和开源 EDA 工具的芯片全链条设计 | 缪宇飏 (中国科学院计算技术研究所) | TBA | TBA |
| 15:10 | 10' | 5 levels of RISC-V Processor Verification | 范宇杰 (新思科技，Application Engineer) | TBA | TBA |
| 15:20 | 20' | 基于 RISC-V 的架构建模及混合仿真验证方法 | 梁琪 (思尔芯 S2C, 产品经理) | TBA | TBA |
| 15:40 | 10' | TBD |  | TBA | TBA |
| 15:50 | 10' | 从 IP 到系统的 RISC-V 敏捷验证方案 | 杨晔 (芯华章科技，科技产品和业务规划总监) | TBA | TBA |
| 16:00 | 10' | Accelerate RISC-V SOC SW/HW co-development with mixed Emulation platforms | Zang Bo（臧博） (Intel (China) Research Center Ltd.) | TBA | TBA |
| 16:10 | 20' | 基于生成式多核 RISC-V 的设计验证方法 | 于兆杰 (无锡亚科鸿禹电子有限公司，AE 总监) | TBA | TBA |
| 16:30 | 10' | CIRCT SV 新进展与蜂鸟 E200 RISC-V CPU 仿真案例 | 孙海龙 (兆松科技（武汉）有限公司，硬件编译器工程师) | TBA | TBA |
| 16:40 | 20' | sdfirm: RISC-V 芯片验证方法论与实践 | 郑律 (sdfirm 社区，社区开发者) | TBA | TBA |
| 17:00 | 10' | EDA 辅助的领域专用 RISC-V 处理器设计 | 姚彦斌 (南京隼瞻科技有限公司，联合创始人兼 CTO) | TBA | TBA |
| 17:10 | 10' | Accelerating Verification using RISC-V and cloud FPGAs | Wajahat Riaz (SilverLining EDA, Verification Engineer) | TBA | TBA |
